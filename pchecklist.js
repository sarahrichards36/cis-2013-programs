...
var passwordCheckOld = function () 
{
    ...
    //inputs the users password
    stringPassword = $("password").value; 
    //this is a list of all the so called bad passwords
    ...
    stringOutput = "";
    //this checks to make sure the password is at least 8 characters
    if(stringPassword.length < 8)
    {
        stringOutput = "Your password is not long enough. Pick one with at least 8 characters or more.";
    }
  else
{
//checks the password with the list of bad ones
//if it is in the list, it will return a message to them
...
//if the password is not in the list and works then it will return a message to them
if (stringOutput != "")
{
